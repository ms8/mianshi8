...
<body>
    ...
    <div class="httop2  loginHead">
        <div class="httop21">
            <div class="logo1"> 
                <a href="<?php echo Yii::app()->createUrl('group'); ?>">设置</a>
            </div>
            <div class="link1">
                 <?php  if(!Yii::app()->user->isGuest){?>
                     <a href="<?php echo Yii::app()->createUrl('/kongjian/info'); ?>">基本设置</a>
                 <?php  } ?>
                <a href="<?php echo Yii::app()->createUrl('/kongjian/changepwd'); ?>">修改密码</a>
                <a href="<?php echo Yii::app()->createUrl('/kongjian/jianli'); ?>">我的简历</a>
                <a href="<?php echo Yii::app()->createUrl('/kongjian/myscore'); ?>">我的积分</a>
            </div>
            <div class="sousuo1">

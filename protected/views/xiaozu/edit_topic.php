...
<!--         <div class="right6">友情小组</div>
        ...
        <div class="right6"> <a href="<?php echo Yii::app()->createUrl('xiaozu/topic',array('id'=>$model->id)); ?>">返回>> <?php echo $model->title;  ?></a></div>
     ...
     $('#addtopic_group').ajaxForm({
         ...
         success:function processJson(data) {
             ...
             if(data.status != 1){
                 ...
                 alert('修改成功');
                 location.href = "<?php echo Yii::app()->createUrl('xiaozu/topic'); ?>/"+data.id;
             }
         }
     });
     $("#sub").live("click",

    ...
    以后可以变为私密小组。
        ...
        <div class="right5a">
            ...
            <div class="right5a2">小组需要审核通过后才能完成创建,管理员会审核申请, 审核结果会用邮通知你,请耐心等待。</div>
            <div class="right5a1">小组标签  · · · · · ·</div>
            <div class="right5a2">小组可以有不超过5个的标签，用来描述小组。标签作为关键词可以被用户搜索到。 多个标签之间用空格分隔开。 </div>
        </div>
...
$('#create_group').ajaxForm({
    ...
    success:function(data) {
      ...
      if(data.status != 1){
        ...
        alert('创建小组成功');
        window.location.href="<?php echo Yii::app()->createUrl('xiaozu/mine'); ?>";
      }
    }
  });

...
<div class="con clear">
            ...
            <div class="leftxb2">
                <div class="leftxb21">来自: <a href="<?php echo  $model->memberOne->kongjian; ?>"><?php echo  $model->memberOne->nickname; ?></a> <?php echo date('Y-m-d H:i:s',$model->create_time) ?>
                    ...
                    <?php if($model->memberOne->id==Yii::app()->user->id){?>
                     <span class="bianji"><a  href="<?php echo Yii::app()->createUrl('xiaozu/edittopic',array('tid'=>$model->id)); ?>">编辑</a></span>
                    <?php }  ?>
  ...
  <div class="leftxc2">
                <a href="<?php echo Yii::app()->createUrl('xiaozu/topic',array('id'=>$model->id)); ?>">查看所有</a>
            </div>
           <?php  }else{?>
  <div class="leftxc2">
                <a href="<?php echo Yii::app()->createUrl('xiaozu/topic',array('id'=>$model->id,'uid'=>$model->memberOne->id)); ?>">只看楼主</a>
            </div>
           <?php } ?>
...
$('.del').click(function(){
           ...
           if(id!=''){
            ...
            if(r){
              $.ajax({
                    type: "POST",
                    url: "<?php echo Yii::app()->createUrl('xiaozu/Huatidel'); ?>",
                    dataType:'json',
                    data: "id="+id,

...
class Helper extends CController
{
  ...
  //$title   标题
  //$message 发送内容
  public static function SendEmail($toEmail,$title,$message,$fromname='面试吧官网')
  {
    $mail  =Yii::app()->mailer;
    $mail->Charset='UTF-8';
    ...
    $mail->IsSMTP();
    $mail->SMTPAuth= true;
    $mail->Username = "25461865@qq.com";  // 你的用户名，或者完整邮箱地址
    $mail->Password = "W1981ncs";     // 邮箱密码
    $mail->SetFrom('25461865@qq.com', $fromname);     // 发送的邮箱和发送人
